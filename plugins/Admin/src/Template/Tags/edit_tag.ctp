...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_tags, ['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
         <div class="form-group row">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('title', ['required' => true, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Tag Title' ]); ?>
            </div>
         </div>
		<?php
		...
		?>
         <div class="form-group row">
            <div class="col-sm-10 col-sm-offset-2">
			   ...
			   <a href="<?php echo Router::url('/admin/tags/list-data',true); ?>" class="btn btn-primary">Cancel</a>
            </div>
         </div>
      </div>
