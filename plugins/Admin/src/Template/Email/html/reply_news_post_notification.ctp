		...
		<tr>
			<td align="center" valign="top">
				<table width="700" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#f7f7f7">
					...
					<tr>
						<td colspan="4" style="font-size:13px; line-height:22px; padding:30px">Hi <?php echo $to_user; ?>,<br/>
						<p>
							<table width="90%" border="0" style="text-align:left; font-family:Arial, Helvetica, sans-serif; color:#333333" cellpadding="5" cellspacing="5">					
								<tr>
									<td>							
									A news has been posted, titled: <a href="<?php echo $url;?>"><?php echo $news_title;?></a>.
									</td>
								</tr>								
							</table>
						</p>
					...
					<tr>
						<td colspan="4" style="font-size:13px; line-height:22px; padding-left: 30px; padding-bottom: 30px;">Thank you,<br> LearnerOn.Net Team.</td><br>
					</tr> 
					<tr bgcolor="#414042">
