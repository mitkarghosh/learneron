...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_advertisement,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<?php
				$image = '';
				if($existing_advertisement->image !=''){
					$image = $existing_advertisement->image;
					$image = Router::url('/uploads/advertisement/thumb/', true).$image;
				}
				if($existing_advertisement->image !=''){ ?>
					<img src="<?php echo $image; ?>" width='728' height='92' style="border:1px solid #000; padding:5px;" />
				<?php } ?>
				</span>
				...
				<p class="error_msg"></p>
				<p class="sm_txt_nm">* Please upload jpg, png, jpeg files only, for best view please add above 728px x 92px image.</p><output id='image_view' style="padding-top:0px;"></output>
            </div>
         </div>
		<?php
