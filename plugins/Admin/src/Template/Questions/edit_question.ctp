...
<article class="content item-editor-page">
   ...
   <?php
   echo $this->Form->create($existing_data, ['id' => 'login-form', 'novalidate' => 'novalidate']);
   ...
   ?>
	...
	<?php } ?>
		...
		<div class="form-group row">
            ...
            <div class="col-sm-4">
               <?php echo $this->Form->input('category_id', ['type'=>'select', 'empty'=>'Select Category', 'options'=>$question_categories, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Category Name', 'value' => $existing_data->category_id, 'required'=>true ]); ?>
            </div>
        </div>
		...
		<div class="form-group row">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('name', ['type' => 'textbox', 'required' => true, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Question title', 'value' => $existing_data->name ]); ?>
            </div>
        </div>
		<div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('short_description', ['type' => 'textarea', 'required' => false, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Eg. Description', 'value' => $existing_data->short_description]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('learning_goal', ['type' => 'textarea', 'required' => false, 'label' => false, 'class' => 'editorClass form-control boxed', 'placeholder' => '', 'value' => $existing_data->learning_goal]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('education_history', ['type' => 'textarea', 'required' => false, 'label' => false, 'class' => 'editorClass form-control boxed', 'placeholder' => '', 'value' => $existing_data->education_history]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('budget_constraints', ['type' => 'textarea', 'required' => false, 'label' => false, 'class' => 'editorClass form-control boxed', 'placeholder' => '', 'value' => $existing_data->budget_constraints]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('preferred_learning_mode', ['type' => 'textarea', 'required' => false, 'label' => false, 'class' => 'editorClass form-control boxed', 'placeholder' => '', 'value' => $existing_data->preferred_learning_mode]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
				...
				?>
               <?php echo $this->Form->input('tags', ['type'=>'select', 'empty'=>'', 'options'=>$all_tags, 'label' => false, 'class' => 'multipleSelectTags form-control boxed', 'placeholder' => 'Tags', 'value' => $tag_ids, 'multiple'=>true, 'required'=>true ]); ?>
            </div>
         </div>
		 <!--<div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-1">
				<?php
				if($existing_data->is_featured == 'Y'){
					echo $this->Form->input('is_featured', ['type'=>'checkbox', 'label' => false, 'class' => '', 'required'=>false, 'div' => false, 'value' => '1', 'checked' ]);
				}else{
					echo $this->Form->input('is_featured', ['type'=>'checkbox', 'label' => false, 'class' => '', 'required'=>false, 'div' => false, 'value' => '1']);
				}
				?>
            </div>
         </div>-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="detailsContent">
                  <p><b>Question:</b> <span class="questionname"></span></p>
				  <p><b>Short Description:</b> <span class="question_shrt_description"></span></p>
	...
	$(document).ready(function(){
		...
		$('#reply_user').click(function(){
			...
			if(cleanContent.length == 0){
				...
				$.ajax({
					type: 'POST',
					dataType: 'JSON',
					url: '<?php echo Router::url("/admin/questions/reply-user/",true); ?>',
		...
		/* End Reply user*/
		  ...
		  $('#suggestion-modal').on('shown.bs.modal', function (e) {
				...
				$('.loading').show();
				$('.detailsContent').hide();
				var promise = $.getJSON('<?php echo Router::url("/admin/questions/view/",true); ?>'+id);
				promise.done(function(response){
					...
					$('.error').hide();
					$('.detailsContent').show();
					$('.questionname').text(response.data.name);
					$('.question_shrt_description').text(response.data.short_description);
