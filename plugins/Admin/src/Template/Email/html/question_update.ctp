	...
	<tr>
        <td align="center" valign="top">
            <table width="700" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#f7f7f7">
                ...
                <tr bgcolor="#414042">
                	<td colspan="4" style="color:#ffffff;font-size:16px; font-weight:bold; text-align:center; padding:10px 15px;">Question Modification</td>
                </tr>
                <tr>
        		 <td colspan="4" style="font-size:13px; line-height:22px; padding:30px">Dear <?php echo $user_data['full_name'];?>,<br/>
				<p>	
				<table width="90%" border="0" style="text-align:left; font-family:Arial, Helvetica, sans-serif; color:#333333" cellpadding="5" cellspacing="5">
					<tr>
						<td>We wanted to let you know that your Question titled: <a href="<?php echo $url;?>"><?php echo $all_data['name'];?></a> has been approved and posted on the LearnerOn.Net site.</td>
					</tr>					
				</table>					
				</p> 
				</td>
