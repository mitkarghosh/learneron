...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_data, ['id' => 'comment-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
		<div class="form-group row">
            ...
            <div class="col-sm-4">
				<span class="form-control boxed"><?php if(!empty($existing_data->user))echo $existing_data->user->name;else echo $existing_data->name;?></span>
            </div>
        </div>
         <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('comment', ['type'=>'textarea', 'required' => true, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Comment' ]); ?>
            </div>
         </div>
		<?php
         ...
         <div class="form-group row">
            <div class="col-sm-10 col-sm-offset-2">
               <?php echo $this->Form->button('Update',['type' => 'submit','class' => 'btn btn-primary']); ?>&nbsp;
				<a href="<?php echo Router::url('/admin/news-comments/list-data',true); ?>" class="btn btn-primary">Cancel</a>&nbsp;
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="detailsContent">
                  <p><b>Comment:</b> <span class="comments"></span></p>
	...
	$(document).ready(function(){
		...
		$('#reply_user').click(function(){
			...
			if(cleanContent.length == 0){
				...
				$.ajax({
					type: 'POST',
					dataType: 'JSON',
					url: '<?php echo Router::url("/admin/news-comments/reply-user/",true); ?>',
		...
		/* End Reply user*/
		  ...
		  $('#suggestion-modal').on('shown.bs.modal', function (e) {
				...
				$('.loading').show();
				$('.detailsContent').hide();
				var promise = $.getJSON('<?php echo Router::url("/admin/news-comments/view/",true); ?>'+id);
				promise.done(function(response){
					localStorage[id] = response.data;
					$('.loading').hide();
					$('.error').hide();
					$('.detailsContent').show();
					$('.comments').text(response.data.comment);
