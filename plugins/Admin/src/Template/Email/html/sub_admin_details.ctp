	...
	<tr>
        <td align="center" valign="top">
            <table width="700" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#f7f7f7">
                ...
                <tr>
        		 <td colspan="4" style="font-size:13px; line-height:22px; padding:30px">Hi <?php echo $userdata['first_name']; ?>,<br/>
				<p>	
				<table width="90%" border="0" style="text-align:left; font-family:Arial, Helvetica, sans-serif; color:#333333" cellpadding="5" cellspacing="5">					
					<tr>
						<td>A site administrator at LearnerOn.Net has created an account for you as Sub Admin. You may login by clicking <a href="<?php echo $url; ?>" style="text-decoration:underline;">here</a>.</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td><small>Note: You can change your password after log in.</small></td>
                    </tr>
				</table>					
				</p> 
				</td>
