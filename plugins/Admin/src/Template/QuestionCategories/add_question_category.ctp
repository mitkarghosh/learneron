...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($new_question_category,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
	<div class="card card-block">
		<div class="form-group row">
			...
			?>
					<option value="<?php echo $key_category;?>" data-level="<?php echo $val_category['level'];?>"><?php echo $val_category['name'];?></option>
			<?php
				}
			}
			?>
