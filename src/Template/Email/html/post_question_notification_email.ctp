					...
					<tr>
						...
						<p>
							<table width="90%" border="0" style="text-align:left; font-family:Arial, Helvetica, sans-serif; color:#333333" cellpadding="5" cellspacing="5">					
								<tr>
									<td>							
									A new question has been posted in your question category, titled: <a href="<?php echo $question_url;?>"><?php echo $question_title;?></a><br />
									You will be able to see question after admin approval.							
									</td>
								</tr>								
							</table>
						</p>
