         ...
         <div class="form-group row">
            <div class="col-sm-10 col-sm-offset-2">
               <?php echo $this->Form->button('Update',['type' => 'submit','class' => 'btn btn-primary']); ?>&nbsp;
				<a href="<?php echo Router::url('/admin/question-comments/list-data',true); ?>" class="btn btn-primary">Cancel</a>&nbsp;
	...
	$(document).ready(function(){
		...
		$('#reply_user').click(function(){
			...
			if(cleanContent.length == 0){
				...
				$.ajax({
					type: 'POST',
					dataType: 'JSON',
					url: '<?php echo Router::url("/admin/question-comments/reply-user/",true); ?>',
		...
		/* End Reply user*/
		  ...
		  $('#suggestion-modal').on('shown.bs.modal', function (e) {
				...
				$('.loading').show();
				$('.detailsContent').hide();
				var promise = $.getJSON('<?php echo Router::url("/admin/question-comments/view/",true); ?>'+id);
