...
<div class="search-banner">
	<div class="question-search-banner">
		<form action="<?php echo Router::url(NULL,true); ?>" method="get">
			<input value="<?php if($this->request->query('search') !== NULL): echo $this->request->query('search'); endif; ?>" type="text" name="search" id="search-term" placeholder="Search by question name and description..." autocomplete="off" />
