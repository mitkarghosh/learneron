...
<div class="body-section">
    <section class="top-question-section">
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-sm-8 question-left" id="mostviewed_question">
					<div class="title">
						<h1>Top Questions</h1>
					</div>
					<div class="question-nav clearfix">
						<ul>
							...
							<li class="active"><a href="<?php echo $this->Url->build(['controller'=>'Sites','action'=>'most-viewed']);?>#mostviewed_question">Most Viewed</a></li>
...
$(function(){
	$(document).on('click', 'a[rel="next"]', function() {
		...
		var target = $(this).attr('href').replace("most-viewed","mostviewed_search");
...
$('#no_of_questions').on('change', function(){
	var url = '<?php echo Router::url(array('controller'=>'/','action'=>'most-viewed'.'?limit='));?>'+this.value+'#perpage';
