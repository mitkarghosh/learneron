...
class NewsTable extends Table{
    ...
    public function buildRules(RulesChecker $rules){
        $rules->add($rules->isUnique(['name'], ['message'=>'This news is already added.']));
        $rules->add($rules->isUnique(['slug'], ['message'=>'This news is already added.']));
        return $rules;
    }
