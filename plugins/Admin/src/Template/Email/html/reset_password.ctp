	...
	<tr>
        <td align="center" valign="top">
            <table width="700" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#f7f7f7">
                ...
                <tr bgcolor="#414042">
                	<td colspan="4" style="color:#ffffff;font-size:16px; font-weight:bold; text-align:center; padding:10px 15px;">Password Reset</td>
                </tr>
                <tr>
        		 <td colspan="4" style="font-size:13px; line-height:22px; padding:30px">Hi <?php echo $first_name; ?>,<br/>
				<p>	
				<table width="90%" border="0" style="text-align:left; font-family:Arial, Helvetica, sans-serif; color:#333333" cellpadding="5" cellspacing="5">
					...
					<tr>
						<td>Please <a href="<?php echo $reset_url; ?>">click here</a> to reset your password.</td>
					</tr>
					<tr>
						<td>URL will expire in 2 hours from now.</b></td>
                    </tr>					
				</table>					
				</p> 
				</td>
