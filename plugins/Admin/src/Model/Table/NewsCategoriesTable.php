...
class NewsCategoriesTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules){
        $rules->add($rules->isUnique(['name'], ['message'=>'This news category is already added.']));
        $rules->add($rules->isUnique(['slug'], ['message'=>'This news category is already added.']));
        return $rules;
    }
	
	public function createSlug ($string=NULL, $id=NULL){
		$this->name = 'NewsCategories';
