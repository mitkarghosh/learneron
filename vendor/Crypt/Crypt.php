...
class Crypt
{
    ...
    public static function generatePassword()
    {
        ...
        $digit = "0123456789";
        $specialCharacter = "!@#$&*";
        $password = substr(str_shuffle($alphabet), 0, 3);
        $password .= substr(str_shuffle($specialCharacter), 0, 2);
        $password .= substr(str_shuffle($digit), 0, 3);
        return $password = substr(str_shuffle(str_shuffle(str_shuffle($password))), 0, 8);
    }
}
